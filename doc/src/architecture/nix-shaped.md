...
hash is exposed through `TALLY_BRIEF_HASH` and verified before evaluation, and
their size does not change the runner argv. The runner records hashes of the exact
