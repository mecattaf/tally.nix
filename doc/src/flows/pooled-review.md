...
| The catalog membership, launch data, pools, or arguments change under the same run ID | The affected node payload diverges and the runner stops instead of silently switching reviewers. |
