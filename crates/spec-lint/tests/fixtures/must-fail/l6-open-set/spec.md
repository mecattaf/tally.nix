# l6-open-set — an open set inside the outcome

Status: proposed
Governs: silent-factory-worklists/l6-open-set.json
Consumers: the spec-lint must-fail corpus test
Supersedes: none

## Outcome

This spec exists to fail one rule class, e.g. the open-set ban. Every other rule passes over it. The
