# l16-model-name — a model name in spec bytes

Status: proposed
Governs: silent-factory-worklists/l16-model-name.json
Consumers: the spec-lint must-fail corpus test
Supersedes: none

## Outcome

This spec names a model, opus, to fail one rule class. Every other rule passes over it. The
