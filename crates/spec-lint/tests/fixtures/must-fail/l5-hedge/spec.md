# l5-hedge — a hedge word inside a claim

Status: proposed
Governs: silent-factory-worklists/l5-hedge.json
...
1.1 the linter reads this corpus spec → the run handles the corpus spec gracefully (given). [gate: cargo-tests]
