# l9-doubly-bound-claim — a claim bound to two oracles

Status: proposed
Governs: silent-factory-worklists/l9-doubly-bound-claim.json
...
1.1 the linter reads this corpus spec → the run reports the named defect (given). [gate: cargo-tests] [check: spec-lint]
