# l11-vocabulary-unused — a term defined and never used

Status: proposed
Governs: silent-factory-worklists/l11-vocabulary-unused.json
...
- orphan noun (NEW) — a term no later line ever reaches for.
