# l12-believe-path — a BELIEVE path that does not resolve

Status: proposed
Governs: silent-factory-worklists/l12-believe-path.json
...
1.1 BELIEVE:evidence/missing.md — the linter reads this corpus spec → the run reports the named defect. [gate: cargo-tests]
