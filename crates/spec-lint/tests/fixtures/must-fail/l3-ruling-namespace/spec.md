# l3-ruling-namespace — a ruling id in the claim-group namespace

Status: proposed
Governs: silent-factory-worklists/l3-ruling-namespace.json
...
| id | decision | ruling |
|---|---|---|
| R1 | breakage | this corpus spec breaks one rule class |
