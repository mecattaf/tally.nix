# l9-binding-count — a claim with no oracle binding

Status: proposed
Governs: silent-factory-worklists/l9-binding-count.json
...
1.1 the linter reads this corpus spec → the run reports the named defect (given).
