...
is `status: "failed"`. The summary line must therefore say the surfaces were
*accounted for*, break the statuses out rather than calling them "covered",
emit `coverage=zero-covered`, and exit 4: nothing here was covered.
...
Before #426 it still exited 0 despite that explicit zero-covered tally.
